...
const PRESETS = {
  ...
  lead: {
    quali: {
      ...
      params: { starters: 22, numRoutes: 2, climbTimeMin: 6, minGapMin: 50 }
    },
    semi: {
      label: "Lead – Halbfinale",
      params: { starters: 24, numRoutes: 1, climbTimeMin: 6, minGapMin: 50 }
    },
    final: {
      label: "Lead – Finale",
      params: { starters: 8, numRoutes: 1, climbTimeMin: 6, minGapMin: 50 }
    }
  },
  speed: {
    quali: {
    ...
    final: {
      ...
      params: { kind: "final", finalistCount: 16, mode: "duel", raceTimeMin: 2, minGapMin: 5 }
    }
  }
};
